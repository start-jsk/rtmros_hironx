...
#        self.robot.goOffPose()
    ...
    def testGetterByFrame(self):
        ...
        self.robot.goInitial(robot.getCurrentPose('robot.getCurrentPose(LARM_JOINT5:DEFAULT)', posel1)
        self.robot.goInitial(robot.getCurrentPose('robot.getCurrentPose(LARM_JOINT5:WAIST)', posel2)
