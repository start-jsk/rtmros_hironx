...
commands="
  ...
  PATH=/usr/pkg/bin:/usr/qnx650/host/qnx6/x86/usr/bin:$PATH PKG_CONFIG_PATH=/usr/pkg/lib/pkgconfig CXX=QCC CC=qcc LDFLAGS=\"-L/opt/jsk/lib -L/usr/pkg/lib -lboost_system -lboost_signals -lboost_filesystem\" CXXFLAGS=\"-I/opt/jsk/include -I/usr/pkg/include -Wall -fPIC -O2 -I../../include/ \" ./configure --host x86-linux-gnu --prefix=/opt/jsk;
